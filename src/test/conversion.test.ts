...
describe('Conversion Types', () => {
  ...
  describe('Type constraints', () => {
    it('should allow valid video codecs', () => {
      const validCodecs: VideoCodec[] = ['libx265', 'libx264', 'libsvtav1', 'copy'];
    ...
    it('should allow valid audio codecs', () => {
      const validCodecs: AudioCodec[] = ['libopus', 'aac', 'libfdk_aac', 'ac3', 'flac', 'copy'];
      validCodecs.forEach(codec => {
        expect(['libopus', 'aac', 'libfdk_aac', 'ac3', 'flac', 'copy']).toContain(codec);
      });
    });
